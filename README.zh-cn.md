...
- **连接浏览器时可能需要数分钟至约十分钟**。通过远程调试协议连接 Chrome 的耗时取决于 Chrome 配置文件大小、系统性能和网络状况，请耐心等待，不要在此期间关闭程序。
...
[English](README.md) | [繁體中文](README.zh-tw.md) | [日本語](README.ja.md) | [Русский](README.ru.md)