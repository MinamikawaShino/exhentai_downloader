EN = {
    ...
    "settings.total_galleries": "{count} galleries",
    ...
    "download.archive_click_fail": "Failed to click Archive Download link.",
    "download.popup_wait_retry": "Waiting for popup, retry {attempt}/3...",
    ...
    "download.corrupt_found": "Found {count} corrupted image(s) in: {dir}",
    "download.corrupt_none": "No corrupted images found in: {dir}",
    "download.webp_converted": "Converted {count} WebP files to PNG",
    "download.corrupt_redownload": "Corrupted images found, scheduling re-download...",
    "download.corrupt_scan_error": "Corrupt scan error: {error}",
    ...
    # Library tab
    "lib.source_dir": "Source Directory",
    "lib.scan_corrupt": "Scan corrupted images",
    "lib.scan_dedup": "Scan duplicate images",
    "lib.folder_dedup": "Duplicate folder dedup",
    "lib.convert_webp": "WebP → PNG conversion",
    "lib.white_bg": "White background (WebP)",
    "lib.db_skip_this": "Skip DB write this time",
    "lib.start_scan": "Start",
    "lib.stop_scan": "Stop",
    "lib.scanning_status": "Scanning...",
    "lib.scan_complete": "Scan complete",
    "lib.ready": "Ready",
    "lib.select_source": "Source directory does not exist",
    "lib.no_function": "Please select at least one function",
    "lib.log": "Log",
    "lib.data_source": "Restore Data",
    "lib.load_json": "Load JSON",
    "lib.load_db": "Load DB",
    "lib.select_all": "Select All",
    "lib.deselect_all": "Deselect",
    "lib.restore_selected": "Restore",
    "lib.trash_selected": "Move to Trash",
    "lib.open_file": "Open",
    "lib.load_manifest_first": "Load a manifest or database first",
    "lib.loaded_entries": "Loaded {count} entries",
    "lib.select_entries": "Please select entries",
    "lib.restore_confirm": "Restore {count} files?",
    "lib.trash_confirm": "Move {count} files to trash?",
    "lib.restoring": "Restoring {count} files...",
    "lib.trashing": "Moving {count} files to trash...",
    "lib.db_not_enabled": "DB cache not enabled",
    "lib.clear_cache": "Clear cache",
    "lib.clear_dups": "Clear dups",
    "lib.clear_cache_confirm": "Clear all scan cache records?",
    "lib.clear_dups_confirm": "Clear all duplicate records?",
    "lib.cache_cleared": "Scan cache cleared",
    "lib.dups_cleared": "Duplicate records cleared",
    "lib.select_manifest": "Please select a manifest file",
    "lib.col_original": "Original Path",
    "lib.col_size": "Size",
    ...
    # Settings - scan
    "settings.scan_section": "Image Scanning",
    "settings.scan_threads": "Scan Threads:",
    "settings.db_enable": "Enable DB Cache",
    "settings.white_bg_webp": "White background for WebP",
    "settings.error_dir": "Error Dir:",
    "settings.dedup_dir": "Duplicate Dir:",
    "settings.trash_dir": "Trash Dir:",
    "settings.theme": "Theme:",
    "settings.theme_light": "Light",
    "settings.theme_dark": "Dark",
    "settings.scan_corrupt_after_extract": "Scan corrupted images after extract",
    "settings.webp_to_png_after_extract": "Auto WebP to PNG after extract",
    "settings.dedup_overlap_threshold": "Folder overlap %:",

    # Config
    "config.no_download_dir": "Please set download directory",

    "settings.download_section": "Download",
    "settings.download_threads": "Download Threads (segmented):",

    "settings.skip_page_threshold": "Skip if page diff ≤:",
    "settings.skip_page_threshold_unit": "pages",

    "download.skip_page_diff": "Local folder page count differs by {diff} > {threshold}, continuing download (web: {web_pages}, local: {local_files})",

    "download.chunked_merging": "Merging download chunks...",
    "download.chunked_complete": "Multi-threaded download complete: {filename}",
    "download.chunked_downloading": "Starting multi-threaded download: {filename} ({threads} threads)",
    "download.chunk_fail": "Chunk {idx} download failed, retrying...",
}